...
const DoctorCard = ({doctor}) => {
  ...
  return (
    <div className='p-3 lg:p-5'>
      <div>
        <img src={photo} className='w-full' alt="Doctor Photo" />
      </div>
...
// this component takes doctor object as a parameter. This doctor object contains various properties like name, avgRating, totalRating, photo, specialization, and experiences.
// This part checks if the experiences array exists and if it has at least one element. Hospital is an object of experiences object