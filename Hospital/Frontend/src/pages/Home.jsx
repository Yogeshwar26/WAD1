          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className='lg:w-[570px]'>
                <h1 className='text-[28px] leading-[38px] text-headingColor font-[800] md:text-[46px] md:leading-[56px]'>We help patients live a healthy, longer life.</h1>
                <p className='text_para'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Sapiente explicabo illo repudiandae quam veniam, perferendis quia nisi quos magni sit, ipsum nostrum voluptate deserunt maiores tempore odio eum qui optio.</p>
        ...
        <div className="container">
          <div className='flex items-center justify-between flex-col lg:flex-row'>
            ...
            <ul className="pl-4">
              ...
              <li className="text_para">
                3. View our physicians who are accepting new patients, use the online scheduling tool to select an appropriate time.
              </li>
            </ul>
        ...
        <div className="container">
          <div className="flex justify-between gap-[50px] lg:gap-0">
            ...
            <div className='w-full md:w-1/2'>
              <h2 className='heading'>Most questions by our beloves patients</h2>
