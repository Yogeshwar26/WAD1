...
const DoctorAbout = ({name, about, qualifications, experiences}) => {
  return (
    <div>
      <div>
        <h3 className='text-[20px] leading-[30px] text-headingCOlor font-semiBolf flex items-cneter gap-2'>
            About of
      ...
      <div className="mt-12">
        <div className="text-[20px] leadng-[30px] text-headingColor font-semibold">
            <h3>Experience</h3>
